...
class Server {
  constructor(_config) {
    ...
    app.post("/v1/users/:id/books", this.middleware.postBook.bind(this.middleware), (req, res) => {
      res.send({
        results: req.addBook,
        status: 200,
      })
    ...
    app.delete("/v1/users/:id/books", this.middleware.deleteBook.bind(this.middleware), (req, res) => {
      res.send({
    ...
    app.patch("/v1/users/:id/books", this.middleware.patchBook.bind(this.middleware), (req, res) => {
      res.send({
